...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String crearTablaUsuario = "CREATE TABLE " + USUARIO_TABLA + " (ID INTEGER PRIMARY KEY AUTOINCREMENT, NOMBRE TEXT, CONTRASEÑA TEXT, IMAGEN BLOB, NUM_TELEFONO INT, EMAIL TEXT, ES_ADMINISTRADOR BOOL);"; //FALTA IMAGEN
    ...
    public boolean anyadeUsuario(Usuario user){ //Añade un usuario a la base de datos
        ...
        cv.put(TELF_USUARIO, user.getCorreo());
